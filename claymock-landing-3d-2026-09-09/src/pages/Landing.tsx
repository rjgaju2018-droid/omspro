...
function Hero() {
  return (
    <section className="relative mx-auto max-w-6xl px-5 pt-10 pb-20 text-center">
      ...
      {/* 3D shipment showcase — a real Three.js scene, not a static graphic */}
      <MotionDiv delay={0.34} className="relative mx-auto mt-4 h-64 max-w-md sm:h-80">
        <div className="pointer-events-none absolute inset-0">
          <Hero3DBox />
        </div>
        <p className="pointer-events-none absolute inset-x-0 bottom-1 text-[11px] font-bold uppercase tracking-widest text-muted-foreground/70">
          live 3D · every parcel, tracked in the round
        </p>
      </MotionDiv>
