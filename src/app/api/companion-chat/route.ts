...
function buildSystemPrompt(companionName: string | null, helpArticlesBlock: string): string {
  ...
  return `You are ${name}, the AI Companion inside OMS Pro, a multi-tenant Order Management System — a friendly,
...
What you know about this OMS (a Next.js + Supabase web app for export businesses — every company on the
platform runs its own workspace):
